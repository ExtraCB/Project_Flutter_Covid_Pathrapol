...
class GlobalStatistics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        buildCard("ยอดติดสะสมทั้งหมด", summary.totalConfirmed,
        ...
        buildCard(
            ...
            kActiveColor),
        buildCard("รักษาหาย", summary.totalRecovered, summary.newRecovered,
            kRecoveredColor),
        buildCard("ตาย", summary.totalDeaths, summary.newDeaths, kDeathColor),
        Padding(
          padding: EdgeInsets.symmetric(horizontal: 4, vertical: 6),
          child: Text(
            "อัพเดตล่าสุด " + timeago.format(summary.date),
            style: TextStyle(
              color: Colors.white,
